            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <a href="awards.php?action=add" class="btn btn-success">
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer bg-transparent">
                                        <a href="edit-award.php?id=<?php echo $award['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                        <a href="delete-award.php?id=<?php echo $award['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; ?>
